        ...
        <div className="p-6 sm:p-8 flex flex-col flex-1">
          <div className="flex flex-col xl:flex-row justify-between gap-6 mb-4">
            <div className="flex-1">
              <h2 className={`font-bold text-slate-900 dark:text-neutral-100 mb-3 font-display leading-snug line-clamp-3 ${index === 0 ? 'text-2xl sm:text-4xl' : 'text-xl sm:text-2xl'}`}>
                {article.title}
              </h2>
          ...
          <p className="text-slate-600 dark:text-neutral-400 text-sm sm:text-base leading-relaxed line-clamp-4 mt-auto">
